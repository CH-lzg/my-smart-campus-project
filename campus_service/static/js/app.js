    ...
    try {
        ...
        if (chartsContainer) {
            ...
            if (distribution.image) {
                chartsHtml += `
                    <div class="chart-card">
                        <h4 style="margin-bottom: 15px; color: #333;">成绩分布直方图</h4>
                        <img src="${distribution.image}" alt="Score Distribution">
                    </div>
                `;
            }
            ...
            if (gpaRanking.image) {
                chartsHtml += `
                    <div class="chart-card">
                        <h4 style="margin-bottom: 15px; color: #333;">GPA排名TOP10</h4>
                        <img src="${gpaRanking.image}" alt="GPA Ranking">
                    </div>
                `;
            }
            ...
            if (courseComparison.image) {
                chartsHtml += `
                    <div class="chart-card">
                        <h4 style="margin-bottom: 15px; color: #333;">课程平均分对比</h4>
                        <img src="${courseComparison.image}" alt="Course Comparison">
                    </div>
                `;
            }
                ...
                container.innerHTML = data.services.map(s => `
                    <div class="service-card">
                        ...
                        <div class="service-info">
                            ${s.location ? `<p><span>📍</span>${s.location}</p>` : ''}
                            ${s.open_time ? `<p><span>🕐</span>${s.open_time}</p>` : ''}
                            ${s.contact ? `<p><span>📞</span>${s.contact}</p>` : ''}
                        </div>
                    </div>
                `).join('');
            }
